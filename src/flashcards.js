...
;(function (root) {
    ...
    function isValidDifficulty(n) {
        return n === undefined ? false : typeof n === "number" && n <= settings.highestDifficulty && n >= settings.lowestDifficulty
    }
    ...
    lib.setSessionInfo = function (newSessionInfo) {
        if (
            !Number.isInteger(newSessionInfo.correct) ||
            ...
            __sessionInfo.minDiff = isValidDifficulty(newSessionInfo.minDiff) ? newSessionInfo.minDiff : __sessionInfo.minDiff
            __sessionInfo.maxDiff = isValidDifficulty(newSessionInfo.maxDiff) ? newSessionInfo.maxDiff : __sessionInfo.maxDiff
